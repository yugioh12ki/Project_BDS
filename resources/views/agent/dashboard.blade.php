...
@section('title', 'Dashboard - Môi giới')
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Dashboard môi giới bất động sản</p>
                </div>
                <div>
                    <span class="badge bg-primary fs-6">Môi giới</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-3 mb-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center">
                    ...
                    <p class="text-muted mb-0">BĐS quản lý</p>
                </div>
            </div>
        </div>
        <div class="col-md-3 mb-3">
        ...
        <div class="col-md-3 mb-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center">
                    ...
                    <h3 class="mb-1">{{ number_format($stats['total_commission']) }}</h3>
                    <p class="text-muted mb-0">Hoa hồng (VNĐ)</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-8 mb-4">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-bottom">
                    <h5 class="mb-0">
                        <i class="fas fa-home me-2 text-primary"></i>Bất động sản được giao
                    </h5>
                </div>
                <div class="card-body">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="fw-semibold">{{ $property->chusohuu->Name ?? 'N/A' }}</div>
                                            <small class="text-muted">{{ $property->chusohuu->Phone ?? '' }}</small>
                                        </td>
                    ...
                    @else
                        <div class="text-center py-4">
                            ...
                            <h5 class="text-muted">Chưa có bất động sản nào được giao</h5>
                            <p class="text-muted">Liên hệ với admin để được phân công bất động sản</p>
                        </div>
                    @endif
                </div>
            </div>
        ...
        <div class="col-lg-4">
                    ...
                    @if($appointments->count() > 0)
                        ...
                        <div class="d-flex align-items-center border-bottom pb-2 mb-2">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <div class="fw-semibold">{{ $appointment->user_customer->Name ?? $appointment->user_owner->Name ?? 'N/A' }}</div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-bottom">
                    <h5 class="mb-0">
                        <i class="fas fa-coins me-2 text-warning"></i>Hoa hồng gần đây
                    </h5>
                </div>
                <div class="card-body">
                    @if($commissions->count() > 0)
                        ...
                        <div class="d-flex align-items-center justify-content-between border-bottom pb-2 mb-2">
                            <div>
                                <div class="fw-semibold">{{ number_format($commission->Amount) }} VNĐ</div>
                                <small class="text-muted">{{ $commission->commission_property->Title ?? 'N/A' }}</small>
                            </div>
                            <div class="text-end">
                    ...
                    @else
                        <div class="text-center py-3">
                            ...
                            <p class="text-muted mb-0">Chưa có hoa hồng nào</p>
                        </div>
                    @endif
                </div>
            </div>
