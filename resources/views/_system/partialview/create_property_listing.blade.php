    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
                ...
                <div class="property-item border rounded mb-3 overflow-hidden">
                  <div class="property-content p-0">
                    ...
                    <div class="p-3">
                      ...
                      <p class="text-muted mb-2"><i class="bi bi-geo-alt me-1"></i> {{ $property->Address }}, {{ $property->Ward }}, {{ $property->District }}, {{ $property->Province }}</p>
          ...
          <div class="modal-footer justify-content-center border-0">
            <button type="submit" class="btn btn-primary btn-lg rounded-pill px-5" id="continueToListingDetailsBtn">
              Tiếp tục
            </button>
          </div>
        </div>
