...
@section('title', 'Chỉnh sửa câu hỏi Chatbot')

@section('chatbotai')
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Chỉnh sửa câu hỏi Chatbot</h1>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.chatbot.questions.update', $question->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('question_text') is-invalid @enderror"
                               id="question_text" name="question_text" value="{{ old('question_text', $question->question_text) }}" required>
                        @error('question_text')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('pattern') is-invalid @enderror"
                               id="pattern" name="pattern" value="{{ old('pattern', $question->pattern) }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('handler') is-invalid @enderror"
                               id="handler" name="handler" value="{{ old('handler', $question->handler) }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('desc') is-invalid @enderror"
                                  id="desc" name="desc" rows="5">{{ old('desc', $question->desc) }}</textarea>
                        @error('desc')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
