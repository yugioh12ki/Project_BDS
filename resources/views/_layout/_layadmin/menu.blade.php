...
<aside class="sidebar">
    <nav class="menu">
      <ul>
        <li><a href="{{ route('admin.users') }}"><i class="fas fa-users"></i> Quản lý danh sách người dùng</a></li>
        <li><a href="{{ route('admin.property') }}"><i class="fas fa-list"></i> Quản lý danh mục BĐS</a></li>
        <li><a href="{{ route('admin.feedback') }}"><i class="fas fa-check-circle"></i> Kiểm duyệt đánh giá khách hàng</a></li>
