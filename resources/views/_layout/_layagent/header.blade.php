<header class="owner-header">
    ...
    <div class="header-nav" style="display:flex; align-items:center; flex-grow:1; justify-content:center;">
        <ul style="display:flex; list-style:none; margin:0; padding:0; gap:20px;">
            <li style="margin:0;"><a href="{{ route('agent.dashboard') }}" class="header-nav-link" style="text-decoration:none; color:#4A4A4A; font-weight:500; padding:8px 12px; display:flex; align-items:center;"><i class="bi bi-house-fill" style="margin-right:6px;"></i> Trang Chủ</a></li>
            <li style="margin:0;"><a href="{{ route('agent.listings') }}" class="header-nav-link" style="text-decoration:none; color:#4A4A4A; font-weight:500; padding:8px 12px; display:flex; align-items:center;"><i class="bi bi-building" style="margin-right:6px;"></i> Danh Sách BĐS</a></li>
            <li style="margin:0;"><a href="{{ route('agent.appointments') }}" class="header-nav-link" style="text-decoration:none; color:#4A4A4A; font-weight:500; padding:8px 12px; display:flex; align-items:center;"><i class="bi bi-calendar-event" style="margin-right:6px;"></i> Lịch Hẹn</a></li>
        </ul>
    </div>
    ...
    <div class="header-right dropdown" style="display:flex; align-items:center; gap:15px;">
        <div class="phone-number-wrapper" style="display:flex; align-items:center;">
            <a href="tel:0123456789" class="phone-link" style="text-decoration:none; color:#4A4A4A; display:flex; align-items:center; font-weight:500; font-size:0.9rem; background-color: #85b6e8; padding: 5px 15px; border-radius: 25px; border: 1px solid rgba(255,255,255,0.3); box-shadow: 0 1px 2px rgba(0,0,0,0.1);">
